...
namespace lab4_5.Classes
{
    ...
    {
        public static ObservableCollection<Ticket> GetDataTable(string nameTable)
        {
        ...
        public static void AddTicketToTable(Ticket ticket)
        { 
            try
            {
        ...
        public static void ChangeTicketToTable(Ticket ticket)
        {
            try
            {
                ...
                if (rowsAffected > 0)
                {
                    Console.WriteLine($"Ticket with ID {ticket.Id} updated successfully.");
                }
                else
                {
                    Console.WriteLine($"Failed to update ticket with ID {ticket.Id}.");
                }
            }
            catch (SqlException ex)
            {
        ...
        public static void DeleteTicketToTable(int id)
        {
